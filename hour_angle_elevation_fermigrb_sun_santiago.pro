pro Hour_angle_elevation_FERMIGRB_sun_Santiago
close,/all
...
root_dir='E:\WORK\GWAC_work\angular_distance_swiftgrb_sun\')
outputfile1=filepath('HA_ELEV_fermigrb_table_1364439272_Santiago',$
root_dir='E:\WORK\GWAC_work\angular_distance_swiftgrb_sun\')
outputfile2=filepath('HA_ELEV_fermigrb_table_1364359868_freq_Santiago',$
root_dir='E:\WORK\GWAC_work\angular_distance_swiftgrb_sun\')
...
ystyle=1,$
xthick=3,ythick=3,$
xtitle='Anltitude of Fermi GRBs at Santiago (degree)',$
XCHARSIZE=1.5,$
